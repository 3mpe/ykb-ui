    ...
    return (
        <div>
            ...
            <form className="create-form" onSubmit={onsubmit}>
                <label>
                    <span>Ad</span>
                    <input type="text" name="fullname" value={data.fullname} onChange={setState} required/>
                </label>

                <label>
                    <span>Email</span>
                    <input type="email" name="email" value={data.email} onChange={setState} required/>
                </label>

                <label>
                    <span>Medeni Durum</span>
                    <select name="maritalStatus" value={data.maritalStatus} onChange={setState} required>
                ...
                <label>
                    <span>Departman</span>
                    <select name="departmentId" value={data.departmentId} onChange={setState} required>
                        {
